...
namespace FASILKOMPOINT.View.Mahasiswa
{
    public partial class BerandaMahasiswa : Form
    {
        public BerandaMahasiswa()
        {
            ...
            btnLihatSKPI.MouseEnter += button2_MouseEnter;
            btnLihatSKPI.MouseLeave += button2_MouseLeave;
        ...
        {
            btnLihatSKPI.BackColor = Color.Blue;
        }
        ...
        {
            RekapDataSKPI rekapDataSKPI = new RekapDataSKPI();
            rekapDataSKPI.Show();
            this.Hide();
        }
        ...
        private void btnLihatSKPI_Click(object sender, EventArgs e)
        {
            // Pemanggilan metode untuk mendapatkan data nama SKPI
            DataTable dataSKPI = SKPIContext.namaSKPI(username); // Ganti "nama_pengguna_anda" dengan nama pengguna yang sesuai

            // Mengambil nama dari hasil query
            string namaMahasiswa = dataSKPI.Rows.Count > 0 ? dataSKPI.Rows[0]["nama_mahasiswa"].ToString() : "Nama Tidak Ditemukan";
            ...
            Document.Create(Container =>
            {
                Container.Page(page =>
                {
                    ...
                    page.Header()
                        .Image(@"D:\KULIAH SISTEM INFORMASI\SEMESTER 3\PBO\Projek\pdfview FIX\pdfview\pdfview\header1.png");
                    page.Content()
                        ...
                        .Column(x =>
                        {
                            ...
                            x.Item().PaddingLeft(33, Unit.Millimetre).Inlined(Inlined =>
                            {
                                ...
                                Inlined.Item().Text($":    {namaMahasiswa}").FontSize(10); //nama
                            });
                            ...
                            x.Item().AlignCenter().PaddingLeft(2, Unit.Centimetre).PaddingTop(5, Unit.Millimetre).Width(10, Unit.Centimetre).Image(@"D:\KULIAH SISTEM INFORMASI\SEMESTER 3\PBO\Projek\pdfview FIX\pdfview\pdfview\KKNI.png").WithRasterDpi(144);
                    ...
                    page.Footer()
                    .Image(@"D:\KULIAH SISTEM INFORMASI\SEMESTER 3\PBO\Projek\pdfview FIX\pdfview\pdfview\footer.png");
                });
            })
        ...
        private DataTable queryExecutor(string query, NpgsqlParameter[] parameters)
        {
